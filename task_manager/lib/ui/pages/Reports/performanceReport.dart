...
import 'package:task_manager/API/model/PerformanceReportDataModel.dart';
...
class _PerformanceReportState extends State<PerformanceReport> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          "Menu > Reports > Performance Report",
...
class TableSource extends AdvancedDataTableSource<PerformanceReportDataModel> {
  ...
  @override
  Future<RemoteDataSourceDetails<PerformanceReportDataModel>> getNextPage(
