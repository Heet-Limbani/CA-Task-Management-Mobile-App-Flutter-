...
import 'package:task_manager/API/model/DueReportDataModel.dart';
...
class TableSource extends AdvancedDataTableSource<DueReportDataModel> {
  ...
  DataRow? getRow(int index) {
    ...
    String ticketValue = dataList.ticket?.toString() ?? '';
    String invoiceValue = dataList.invoice?.toString() ?? '';
    String totalValue = dataList.total?.toString() ?? '';
