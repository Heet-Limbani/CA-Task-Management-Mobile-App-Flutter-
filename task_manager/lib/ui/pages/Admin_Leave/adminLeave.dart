...
import 'package:task_manager/API/model/employeeLeaveDataModel.dart';
import 'package:task_manager/API/model/genModel.dart';
import 'package:task_manager/ui/pages/Admin_Leave/adminLeaveAdd.dart';
import 'package:task_manager/ui/pages/Admin_Leave/adminLeaveEdit.dart';
...
class TableSource extends AdvancedDataTableSource<EmployeeLeaveDataModel> {
  ...
  void deleteAdminLeave(String? id) async {
    if (id != null) {
          ...
          Container(
            ...
            child: Row(
              children: [
                RawMaterialButton(
                  onPressed: () {
                    Get.to(AdminLeaveEdit(id: dataList.id!));
                  },
