class TaskPaymentDataModel {
  Data? data;
  List<Payment>? payment;
  InvoiceData? invoiceData;

  TaskPaymentDataModel({this.data, this.payment, this.invoiceData});

  TaskPaymentDataModel.fromJson(Map<String, dynamic> json) {
...
class Payment {
  ...
  Payment({this.id, this.name, this.isFixed, this.dl});
