...
class Card {
  ...
  Card.fromJson(Map<String, dynamic> json) {
    ...
    if (json['tax_payable'] != null) {
      taxPayable = <TaxPayable>[];
      json['tax_payable'].forEach((v) {
        taxPayable!.add(new TaxPayable.fromJson(v));
      });
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.pending1 != null) {
     ...
     if (this.taxPayable != null) {
      data['tax_payable'] = this.taxPayable!.map((v) => v.toJson()).toList();
    }
...
class TaxPayable {
  ...
  TaxPayable.fromJson(Map<String, dynamic> json) {
    ticketId = json['ticket_id'];
    uniqueId = json['unique_id'];
    createdBy = json['created_by'];
    clientId = json['client_id'];
