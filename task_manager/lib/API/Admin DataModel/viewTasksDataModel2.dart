class TasksData2 {
  Data? data;
  List<Subtask2>? subtask;
  Company2? company;
  List<Department2>? department;
  String? ticketId;
  ...
  TasksData2.fromJson(Map<String, dynamic> json) {
    data = json['data'] != null ? new Data.fromJson(json['data']) : null;
    if (json['subtask'] != null) {
      subtask = <Subtask2>[];
      json['subtask'].forEach((v) {
        subtask!.add(new Subtask2.fromJson(v));
      });
    }
    company =
        json['company'] != null ? new Company2.fromJson(json['company']) : null;
    if (json['department'] != null) {
      department = <Department2>[];
      json['department'].forEach((v) {
        department!.add(new Department2.fromJson(v));
      });
    }
...
class Subtask2 {
  ...
  Subtask2.fromJson(Map<String, dynamic> json) {
...
class Company2 {
  ...
  Company2.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    userId = json['user_id'];
...
class Department2 {
  ...
  Department2({this.id, this.name, this.dl});

  Department2.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
    dl = json['dl'];
  }
