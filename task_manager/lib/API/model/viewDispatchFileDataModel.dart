class ViewDispatchFileDataModel {
  List<File>? file;
  String? fromdate;
  String? todate;

  ViewDispatchFileDataModel({this.file, this.fromdate, this.todate});

  ViewDispatchFileDataModel.fromJson(Map<String, dynamic> json) {
    if (json['file'] != null) {
      file = <File>[];
      json['file'].forEach((v) {
